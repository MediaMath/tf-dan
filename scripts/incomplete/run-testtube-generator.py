...
def TestTubeGenerator(hparams): 
	...
	testtube_dir = model_dir + 'testtube_2/'
	...
	#3.3.2 Result Logging: Experiment Class 
	exp.save()
...
parser.add_argument(
	'--num_epochs', type=int, default=16,
