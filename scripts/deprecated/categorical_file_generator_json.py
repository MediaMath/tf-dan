...
def categorial_file_mass_generator(input_dir, output_dir): 
    ...
    >>> Command Line Examples: 
        python categorical_file_generator_json.py --train_dir path/to/directory/csv --output_dir path/to/directory/
        python categorical_file_generator_json.py --train_dir "/Users/james.f.xue/Desktop/work/raw/" --output_dir "/Users/james.f.xue/Desktop/work/processed/"
    """
    ...
    for file in file_list: 
        ...
        for column in cat_columns: 
            if dictionary[column] is not None: 
                ...
                existing_uniques = dictionary[column]
                combined_uniques = np.concatenate((uniques, existing_uniques), axis=None) 
