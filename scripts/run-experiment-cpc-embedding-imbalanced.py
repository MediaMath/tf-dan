...
parser.add_argument(
	'--early_stopping', type=int, default=4,
...
parser.add_argument(
	'--oversample', type=int, default=1,
	help='Adds n times oversampling to positive class in training set.')
...
# Load data
if not TEST:
	X_train, y_train = ut.load_data_imb(
		os.path.join(DATA_DIR, TRAIN_CSV),
		target='conversion_target',
		positive_upsample=OVERSAMPLE)
